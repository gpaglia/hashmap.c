...
#define FMIX32(h) h^=h>>16; h*=0x85ebca6b; h^=h>>13; h*=0xc2b2ae35; h^=h>>16;
    ...
    uint32_t k4 = 0;
    switch(len & 15) {
    case 15: k4 ^= tail[14] << 16; FT;
    case 14: k4 ^= tail[13] << 8; FT;
    case 13: k4 ^= tail[12] << 0; 
             k4 *= c4; k4  = ROTL32(k4,18); k4 *= c1; h4 ^= k4;
             FT;
    case 12: k3 ^= tail[11] << 24; FT;
    case 11: k3 ^= tail[10] << 16; FT;
    case 10: k3 ^= tail[ 9] << 8; FT;
    case  9: k3 ^= tail[ 8] << 0; 
             k3 *= c3; k3  = ROTL32(k3,17); k3 *= c4; h3 ^= k3;
             FT;
    case  8: k2 ^= tail[ 7] << 24; FT;
    case  7: k2 ^= tail[ 6] << 16; FT;
    case  6: k2 ^= tail[ 5] << 8; FT;
    case  5: k2 ^= tail[ 4] << 0;
             k2 *= c2; k2  = ROTL32(k2,16); k2 *= c3; h2 ^= k2;
             FT;
    case  4: k1 ^= tail[ 3] << 24; FT;
    case  3: k1 ^= tail[ 2] << 16; FT;
    case  2: k1 ^= tail[ 1] << 8; FT;
    case  1: k1 ^= tail[ 0] << 0;
             k1 *= c1; k1  = ROTL32(k1,15); k1 *= c2; h1 ^= k1;
             FT;
    };
